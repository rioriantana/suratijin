...
<html>
<head>
	<title>Surat Ijin Akses Lab</title><?php
	...
	<body>
		<div id="margin">
			...
			<div class="isi">
				...
				Hal <div class="tab-hal"> : Permohonan Ijin Akses Lab </div>
				...
				<div class="prg-1"><p>Dengan hormat,<br>Kami sampaikan dengan hormat bahwa yang bertanda tangan dibawah ini Pembimbing Tugas Akhir, menerangkan bahwa mahasiswa tersebut dibawah : </p></div>
				...
				<div class="prg-2"><p>Adalah mahasiswa Program Studi Fisika FMIPA UNS yang akan melaksanakan <?php echo $key->keperluan; ?>, sehubungan dengan hal tersebut mohon yang bersangkutan diberikan ijin untuk mengakses dan menggunakan alat di  <?php echo $key->nama_instansi; ?> mulai tanggal  <?php $tanggal_mulai = new DateTime($key->tanggal_mulai); echo $tanggal_mulai->format('d-m-Y'); ?> sampai dengan <?php $tanggal_selesai = new DateTime($key->tanggal_selesai); echo $tanggal_selesai->format('d-m-Y'); ?>.</p></div>
				...
				<div>Mengetahui,</div>
				<div class="jabatan">Kepala Program Studi Fisika, <div class="koordinator-kkn">Pembimbing <?php echo $key->instansi_pemohon; ?>,</div></div>
