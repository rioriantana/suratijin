    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Ijin Uji Sample</h1>
                </div>
            </div>
                <!-- /.row -->
                <div class="row">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    <form role="form" method="post" action="<?php echo base_url();?>index.php/uji_sample/update">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <a href="<?php echo base_url()."index.php/uji_sample/delete?id=".$key->id;?>" class="btn btn-danger" >Delete</a>
                                            </div>
